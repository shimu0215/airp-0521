...
checkpoint = torch.load('saved_model/PaiNN-0903-10.pth')
...
writer = SummaryWriter(log_dir=f"log/0903_{datetime.now().strftime('%Y%m%d_%H%M%S')}")
    ...
    with torch.no_grad():
        ...
        if best_val_loss >= val_loss:
            ...
            torch.save({'model_state_dict': model.state_dict(),
                        ...
                        'best_val_loss': best_val_loss}, path + 'PaiNN-0903-11.pth')
        else:
            patience -= 1
            decay_patience -= 1
